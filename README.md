...
Você pode instalar `twalkR` diretamente do GitHub com o pacote `devtools`:

```r
# Se você não tiver o pacote 'devtools', instale-o primeiro
# install.packages("devtools")

devtools::install_github("seu-usuario-github/twalkR")
```
